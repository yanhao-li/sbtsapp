...
//Method to get the information of the selected contract   
    ...
    ResultSet rst = this.execQuery("SELECT t.TaskID, t.StartDate, t.EndDate, t.BookID, t.TaskType, t.TaskNotes, t.TaskStatus, t.TechnicianID, 
        e.EmpFirstName, e.EmpLastName From Task t, Employees e WHERE t.BookID = '"+bookid+"' && t.TechnicianID = e.EmpID");
    int columns = 10;
    int records = RecordNum(rst);
    String temp;
    String [][] result = new String[records][columns];
...
//Method to get the information of the selected contract
   ...
   public int RecordNum(ResultSet rst) throws SQLException{
    ...
    //Method to get the list of books that are still not published.
    public String[][] getBooksNotPublished() throws SQLException{ 
    ResultSet rst = this.execQuery("select e.EmpFirstName,e.EmpLastName, b.Title
from Employees e left join Book 
b on e.EmpID = b.ShepherdID 
where b.PublishedDate is NULL
