...
public class ViewBooksNotPublished extends maxapp.Control{
    protected DBI dbi;
    ...
    getBooksNotPublished(bean);
    gotoPage("/ViewBooksNotPublished.jsp", request, response); //dispatch to ViewBooksNotPublished

    }

    //Method to retrieve the list of books that is not yet published.
private void getBooksNotPublished(maxapp.Shared bean) throws ServletException, IOException{
        String[][] books;
        maxapp.DBI dbi = null;
try{
    dbi = new maxapp.DBI();
